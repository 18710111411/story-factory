...
| 工具 | 用途 | 使用时机 |
|------|------|---------|
| `polish_skill.md` | 全面润色（文笔/心理/景色/外貌） | 初稿完成后 |
| `polish_tool.md` | 润色模式选择（精修/快速/去 AI 味） | 初稿完成后 |
| `expand_tool.md` | 扩写（大纲→正文） | 只有大纲时 |
| `sensitive_words.md` | 敏感词检测 | 发布前 |

**润色维度**:
- 去 AI 味：替换高频 AI 词、句式多样化
- 文笔提升：修辞手法、词汇丰富度、节奏控制
- 可读性：段落长短、对话分段、场景转换
- 心理描写：内心独白、情绪层次
- 景色描写：五感体验、营造氛围
- 外貌描写：符合人设、避免脸谱化
...
| 工具 | 用途 | 使用时机 |
|------|------|---------|
| `07_高级工具/01_拆书工具.md` | 拆解爆款 | 开书前 |
| `07_高级工具/02_大纲生成器.md` | 生成大纲 | 开书前 |
| `07_高级工具/03_黄金开头.md` | 生成开头 | 写前 3 章 |
| `07_高级工具/04_投稿攻略.md` | 投稿指南 | 发布前 |
| `08_素材库/场景素材库.md` | 场景描写 | 卡文时 |
| `08_素材库/情节素材库.md` | 情节套路 | 卡文时 |
| `08_素材库/人设生成器.md` | 角色设定 | 开书前 |
| `08_素材库/书名简介生成器.md` | 书名简介 | 开书前 |
